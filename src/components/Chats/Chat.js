...
export default function Chat() {
  ...
  useEffect(() => {
    ...
    // console.log("object",otherUserId,"ooooooooooooooooo",currentUserId)
    // Replace this with the actual other user ID
  ...
  const sendMessage = () => {
    let messageReceiver = partner ? partner.partner : receiver;
...
<div className="bg-white rounded shadow w-96 mt-[50px]">
      {/* Header */}
