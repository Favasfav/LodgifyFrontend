...
//   useEffect(() => {
//     previousmsg()
//     console.log('user.id999999999999', user.user_id);
//     console.log("hhhhhhhh77777777hhhhh",sender);
//     console.log("object5555555555555555",otherUserId,currentUserId)
...
// <div className="bg-white p-10 rounded shadow w-auto mt-[50px]">
//       {/* Header */}
...
export default function Chat() {
  ...
  const sendMessage = () => {
    let messageReceiver = partner ? partner.partner : sender;
