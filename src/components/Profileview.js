...
function Profileview() {
  ...
  return (
    <div className=" p-5 bg-slate-800">
      <div className="max-w-4xl bg-grey-400 pt-20 flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0">
        {/*Main Col*/}
        ...
        >
          ...
          <div className="p-4 md:p-12 text-center lg:text-left">
            ...
            <p className="pt-8 text-sm">
              "Unlock Unforgettable Stays with Lodgify: Your Gateway to
              Hassle-Free Reservations."
            </p>
            <div className="pt-12 pb-8">
              <Button
                className="bg-green-700 hover:bg-green-900 text-white font-bold py-4 px-4 rounded-full"
                onClick={() => {
                  navigate("/ProfileUpdateModel");
                }}
              >
                Edit Profile{" "}
              </Button>
            ...
            <div className="pt-4 pb-8">
              <Button
                className="bg-green-700 hover:bg-green-900 text-white font-bold  px-4 rounded-full"
                onClick={toggleOpen}
              >
                Open For See The wallet{" "}
              </Button>
              <Collapse open={open}>
                <Card className="my-4 mx-auto w-8/12">
                  <CardBody>
                    <Typography>WALLET MONEY:{walletBalance}</Typography>
                  </CardBody>{" "}
                </Card>
              </Collapse>
            </div>
