...
function Header() {
  ...
  <nav className="sticky inset-0 z-10 block h-max w-full max-w-full rounded-none border border-white/80 bg-white bg-opacity-80 py-2 px-4 text-white shadow-md backdrop-blur-2xl backdrop-saturate-200 lg:px-8 lg:py-4">
    <div className="flex items-center text-gray-900">
      ...
      >
        <img className='w-10 h-10' src="https://lodgifyproject.s3.amazonaws.com/logo.png"
/>
      </p>
  ...
  <Link onClick={handlePartnerLogin} to={  '/login' }>Partner Login</Link>
)}
 ...
 'My Profile</Link>
        ...
        <MenuItem className="flex items-center gap-2 ">
          ...
          <Typography onClick={logoutUser} variant="small" className="font-normal">
            Sign Out
          </Typography>
        </MenuItem>
      </MenuList>
