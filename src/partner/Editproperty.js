...
function Editproperty() {
    ...
    const property=locations.state.property
    
    
    console.log("paroperty",property)
    const navigate = useNavigate();
    const {user} =useContext(AuthContext)
    console.log("user--------------------",user)
    let form = useRef(null);
    const [partner,setPartner]=useState(property.partner)
    ...
    const handleSubmit = async (e) => {
      e.preventDefault();
      console.log("formdata---------------------------------id---------",property.id);
    ...
    Axiosinstance
    .put(`partner/updateproperty/${property.id}/`,formData)
    .then((response)=>{
          ...
          <form id="login" onSubmit={handleSubmit}>
            <div className="bg-white dark:bg-gray-800">
                  ...
                  <div className="xl:w-9/12 w-11/12 mx-auto xl:mx-0">
                    ...
                    <div className="mt-16 flex flex-col xl:w-2/6 lg:w-1/2 md:w-1/2 w-full">
                      ...
                      <select
                        id="property_type"
                        name="property_type"
                        placeholder={property.propertyType}
                    ...
                    <div className="flex flex-row flex-wrap p-5">
                      <div className="w-1/2 pr-2 ">
                        ...
                        <input
                          ...
                          placeholder={property.total_rooms}
                      ...
                      <div className="w-1/2 pl-2 ">
                        ...
                        <input
                          ...
                          placeholder={property.single_room_price}
                    ...
                    <div className="flex flex-row flex-wrap p-5">
                      <div className="w-1/2 pr-2">
                        ...
                        <input
                          ...
                          id="adultprice"
                          name="adultprice"
                          placeholder={property.adults_price}
                    ...
                    <div className="flex flex-row flex-wrap p-5">
                      <div className="w-1/2 pr-2">
                        ...
                        <input
                          ...
                          placeholder={property.total_room_price}
                    ...
                    <div className="mt-8 flex flex-col xl:w-3/5 lg:w-1/2 md:w-1/2 w-full">
                      ...
                      <textarea
                        ...
                        placeholder={property.room_description}
              ...
              <div  className="p-60" style={{ position: "relative" }}>
                <MapComponent value={property.maplocation} location={location} setLocation={setLocation} />
              </div>
                  ...
                  <div className="container mx-auto">
                    <div className="xl:w-1/4 lg:w-1/2 md:w-1/2 flex flex-col mb-6">
                      ...
                      <input
                        ...
                        placeholder={property.property_address}
                        onChange={(e) => {
              ...
              <div className="flex items-center">
                <div className="h-6 mr-4">
                  <input
                    ...
                    type="checkbox"
                    // checked={property.swimming_pool}
  ...
  <input
    ...
    type="checkbox"
    // checked={property.parking} // Set the initial value here
  ...
  />
              ...
              <div className="flex flex-row flex-wrap p-5">
                ...
                <select
                  id="category_type"
                  name="category_type"
                  placeholder={property.category.category}
