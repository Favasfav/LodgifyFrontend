...
function Searchedproperty() {
  const [mobileFiltersOpen, setMobileFiltersOpen] = useState(false);
  const location = useLocation();
  const searchedproperty = location.state?.searchedproperty;
  ...
  console.log("searchedproperty", properties);
  return (
    <div className="bg-white text-center" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '100vh' }}> 
                  ...
                  <section className="bg-gray-100 py-8">
                    <div className="container mx-auto px-4">
                      <h2 className="text-3xl font-semibold mb-6">
                       Searched Properties for {searched}
                      </h2>
